...
export type PageKey = 'dashboard' | 'projects' | 'projects' | 'daily-logs' | 'calendar' | 'timesheets' | 'onsite-walk' | 'action-items' | 'reports' | 'job-audit' | 'archive' | 'settings';
...
export const ROLE_ACCESS: Record<UserRole, PageKey[]> = {
  site_manager: ['dashboard', 'projects', 'projects', 'onsite-walk', 'daily-logs', 'action-items', 'calendar', 'timesheets', 'reports', 'job-audit', 'archive', 'settings'],
